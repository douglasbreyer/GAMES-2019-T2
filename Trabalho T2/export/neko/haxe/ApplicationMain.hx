...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Trabalho T1", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Trabalho T1", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Trabalho T1";
		app.meta["name"] = "Trabalho T1";
